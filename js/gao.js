...
(function(){
	...
	if (_gaid) {
		...
		(function() {
			...
			ga.src = ('https:' == document.location.protocol ? 'https://web.archive.org/web/20191218005630/https://ssl' : 'https://web.archive.org/web/20191218005630/http://www') + '.google-analytics.com/ga.js';
	...
	if (_uaid) {
		...
		})(window,document,'script','https://web.archive.org/web/20191218005630/http://www.google-analytics.com/analytics.js','ga');
...
(function(){
	...
	addEvt(window,'load',function(){
		...
		tagjs.async = true;
		tagjs.src = "//web.archive.org/web/20191218005630/http://s.yjtag.jp/tag.js#site=WWwSEkZ";
		s.parentNode.insertBefore(tagjs, s);
	});
	
	var tag = '<!-- Global site tag (gtag.js) - AdWords: 999196363 -->';
	tag += '<script async src="https://web.archive.org/web/20191218005630/https://www.googletagmanager.com/gtag/js?id=AW-999196363"></script>';
	tag += '<script>';
...
/*
     FILE ARCHIVED ON 00:56:30 Dec 18, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:01:38 Aug 10, 2022.
...
/*
playback timings (ms):
  captures_list: 175.906
  exclusion.robots: 0.089
  exclusion.robots.policy: 0.08
  RedisCDXSource: 4.162
  esindex: 0.009
  LoadShardBlock: 153.791 (3)
  PetaboxLoader3.datanode: 131.505 (6)
  PetaboxLoader3.resolve: 158.804 (2)
  CDXLines.iter: 12.466 (3)
  load_resource: 158.008
*/